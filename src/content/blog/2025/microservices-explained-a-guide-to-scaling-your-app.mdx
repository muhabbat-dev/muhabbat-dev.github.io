...
- **Difficult to Scale:** If your payment processing module gets a ton of traffic, you have to scale the _entire_ application, which is inefficient and expensive.
...
The first step is to look at your application through the lens of business functions, not technical layers. What does your application _do_? For a social media app, these capabilities might include:
...
Now, imagine your app goes viral, and video uploads are overwhelming your servers. With this architecture, you can scale _only_ the **Media Service** without touching anything else. The rest of the app remains stable and performant.
